...
def main() -> None:
    parser = get_parser("8-channel pair traffic example: can0-can1 / can2-can3 / can4-can5 / can6-can7, all 8 channels TX+RX")
    ...
    try:
        ...
        print(f"Running 8-channel threading demo for {run_duration_s:.1f}s...")
        ...
        print_stats_summary("8-channel pair summary", CHANNELS, stats, elapsed_s)
        for bus in buses:
            bus.shutdown()
