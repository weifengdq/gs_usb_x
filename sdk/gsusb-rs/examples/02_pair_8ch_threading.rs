...
fn main() -> Result<()> {
    ...
    let options = parse_common_options(&args, "8-channel pair traffic example: can0-can1 / can2-can3 / can4-can5 / can6-can7, all 8 channels TX+RX")?;
    ...
    run_multi_summary_demo(
        &format!("Running 8-channel threading demo for {:.6}s...", options.duration_s),
